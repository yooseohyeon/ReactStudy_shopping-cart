...
const EmptyCartNoticeContainer = styled.div`
  display: flex;
...
export default function EmptyCartNotice() {
  return (
    <EmptyCartNoticeContainer>
      <svg xmlns="http://www.w3.org/2000/svg" width="80px" height="80px" viewBox="0 -960 960 960" fill="#999999">
      ...
      <EmptyCartNoticeTitle>장바구니에 담긴 상품이 없습니다.</EmptyCartNoticeTitle>
    </EmptyCartNoticeContainer>
  )
}